...
<?php
	...
	$month_id = $row['id'];
			...
			<h3 data-appear-animation="rotateInUpRight"><?php echo $row['month'];?><span> <?php echo $row['year']; ?></span></h3>
				...
				<a href="<?php echo base_url();?>index.php?accountant/reportpermonth/<?php echo $row['month'].'_'.$row['year'];?>" class="btn btn-primary btn-sm" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo get_phrase('view');?>">
				...
				<table class="table table-bordered table-striped table-condensed mb-none" id="datatable-tabletools">
					...
					<tbody>
						...
						<td><?php echo $rowz['year'];?></td>
							...
							<td>
							<a href="<?php echo base_url();?>index.php?accountant/reportpermonth/<?php echo $rowz['month'].'_'.$rowz['year'];?>">
                <i class="fa fa-eye"></i> Reconcilliations
                 </a>
							</td>
						</tr>
