		...
		<div class="col-lg-12">
			<section class="panel">
				<header class="panel-heading">
					<h2 class="panel-title">Search by Mobile</h2>
				</header>
				<div class="panel-body">
					<div class="form-horizontal form-bordered validate">

						<div class="form-group">
							<label class="col-md-3 control-label">Enter Phone Number</label>
							<div class="col-md-6">
								<input type="text" id="phone_number" class="form-control" name="phone" placeholder="Enter Phone Number">
							</div>
						</div>
...
<script>
	...
	$('#search_client').on('click', function() {
		...
		$.ajax({
			url: '<?php echo base_url(); ?>index.php?client/search_client_by_phone',
			type: 'POST',
			data: { phone: phone },
			dataType: 'json',
	...
	$('#send_money_btn').on('click', function() {
		...
		$.ajax({
			url: '<?php echo base_url(); ?>index.php?client/send_byMobile_to_primary_account',
			type: 'POST',
			data: {
