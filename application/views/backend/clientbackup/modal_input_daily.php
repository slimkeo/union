...
<?php 
$id		=	$this->db->get_where('assignment' , array('assignment_id' => $param2) )->row()->assignment_id;

//$currentDateTime = date('Y-m-d',strtotime($date . "-1 days"));
$currentDateTime = "2018-11-01";
...
<section class="panel">
	...
	<?php echo form_open(base_url() . 'index.php?administrator/dailyrecon/create/' , array('class' => 'form-horizontal form-bordered validate','target'=>'_top'));?>
	<div class="panel-heading">
		<h4 class="panel-title" >
			<i class="fa fa-pencil-square"></i>
			<?php echo get_phrase('input_cash');?> - 
			<?php echo $marshal_name; ?>
		</h4>
	</div>
	...
	<div class="panel-body">
		...
		<select data-plugin-selectTwo class="form-control populate" name="bay_id" onchange="class_section(this.value)" style="width: 100%">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<input type="text" class="form-control" name="returns" value=""/>
						</div>
					</div>
