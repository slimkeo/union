        ...
        while (($row = fgetcsv($handle)) !== false) {
            ...
            if ($member) {
                ...
                if (!$sms_exists && !empty($sms_cellnumber)) {                    
                    ...
                    $updating_message = "Valued Member, your SNAT UNION Number Number is 058-{$member->id}. Tell other VMs to update their KYC for Union Numbers here https://tinyurl.com/594xz6kk";
                    // Send SMS
                ...
                if (!$sms_exists && !empty($cellnumber)) {
                    // Construct SMS message
                    $sms_message = "Valued Member, your SNAT UNION Number is 058-{$member_id}. Tell other VMs to update their KYC for Union Numbers here https://tinyurl.com/594xz6kk I";
                    // Send SMS
