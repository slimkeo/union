        ...
        while (($row = fgetcsv($handle)) !== false) {
            ...
            if ($member) {
                ...
                if (!$sms_exists && !empty($member->cellnumber)) {                    
                    ...
                    $updating_message = "Valued Member, your UNION Number is ".$member->id.". Tell other VMs to update their KYC via Rep";
                    // Send SMS
                ...
                if (!$sms_exists && !empty($cellnumber)) {
                    // Construct SMS message
                    $sms_message = "Valued Member, your UNION Number is ".$member_id.". Tell other VMs to update their KYC via Rep";
                    // Send SMS
