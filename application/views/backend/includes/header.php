...
<header class="header">
	<div class="logo-container">
		<a href="<?php echo base_url();?>index.php?union/dashboard" class="logo">
		...
		<div id="userbox" class="userbox">
			...
			<div class="dropdown-menu">
				<ul class="list-unstyled">
					...
					<!-- goto profile -->
					<li>
						<a role="menuitem" tabindex="-1" href="<?php echo base_url();?>index.php?<?php echo $account_type;?>/security_settings"><i class="fa fa-user"></i> <?php echo get_phrase('edit_profile');?></a>
					</li>
					<li>
