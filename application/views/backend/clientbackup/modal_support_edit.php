<?php
$edit_data = $this->db->get_where( 'support', array( 'support_id' => $param2 ) )->result_array();
	...
	<div class="row">
		<div class="col-md-12">
			<section class="panel">
				...
				<?php echo form_open(base_url() . 'index.php?admin/support/do_update/'.$row['support_id'] , array('class' => 'form-horizontal form-bordered','target'=>'_top', 'id' => 'form', 'enctype' => 'multipart/form-data'));?>
				
				<div class="panel-heading">
					<h4 class="panel-title">
            		<i class="fa fa-pencil-square"></i>
					<?php echo get_phrase('edit_support');?>
            	</h4>
						...
						<div class="col-md-7">
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
									<img src="<?php echo $this->crud_model->get_image_url('support' , $row['support_id']);?>" alt="...">
								</div>
