...
class Crud_model extends CI_Model {
	 ...
	 function all_incidents()
    {
        ...
        return $this->db->get('incident')->result_array(); 
    }
    ...
    function get_marshal_name($marshal_id) {
        $query = $this->db->get_where('marshal', array('marshal_id' => $marshal_id));
        $res = $query->result_array();
        foreach ($res as $row)
            return $row['name'];
    }
	
	  function get_indate_name($id) {
        $query = $this->db->get_where('indates', array('id' => $id));
        $res = $query->result_array();
        foreach ($res as $row)
            return $row['date'];
    }
    ...
    function get_week_name($week_id) {
        $query = $this->db->get_where('weeks', array('week_id' => $week_id));
        $res = $query->result_array();
        foreach ($res as $row)
            return $row['week'];
    }
	    ...
	    ////////////FAMILY///////////
    function get_family_name($company_id) {
    ...
    //////////EXAMS/////////////
    function get_vitals() {
        $query = $this->db->get_where('vitals' , array(
