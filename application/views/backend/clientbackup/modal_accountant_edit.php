	...
	<div class="row">
		<div class="col-md-12">
			<section class="panel">
				...
				<?php echo form_open(base_url() . 'index.php?admin/accountant/do_update/'.$row['accountant_id'] , array('class' => 'form-horizontal form-bordered','target'=>'_top', 'id' => 'form', 'enctype' => 'multipart/form-data'));?>
