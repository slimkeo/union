                ...
                <div class="row">
                    <div class="col-lg-12" data-appear-animation="fadeInRightBig">
                        <?php
                            ...
                            $gwa = $this->db->get_where('dailybymonths', array(
                                'street_id' => 1,
                                'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $gwa2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 1,
                               'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $dze = $this->db->get_where('dailybymonths', array(
                                'street_id' => 2,
                                'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $this->db->select_sum('actual');
                            $dze2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 2,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $zwi = $this->db->get_where('dailybymonths', array(
                                'street_id' => 12,
                                'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $this->db->select_sum('actual');
                            $zwi2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 12,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $bet = $this->db->get_where('dailybymonths', array(
                                'street_id' => 4,
                                'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $this->db->select_sum('actual');
                            $bet2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 4,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $msa = $this->db->get_where('dailybymonths', array(
                                'street_id' => 9,
                                'month' => $month
                            ))->row()->cash;
                            
                            $this->db->select_sum('actual');
                            $msa2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 9,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $mda = $this->db->get_where('dailybymonths', array(
                                'street_id' => 8,
                               'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $this->db->select_sum('actual');
                            $mda2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 8,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $mah = $this->db->get_where('dailybymonths', array(
                                'street_id' => 7,
                                'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $this->db->select_sum('actual');
                            $mah2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 7,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $lib = $this->db->get_where('dailybymonths', array(
                                'street_id' => 6,
                                'month' => $month
                            ))->row()->cash;
                            
                            $this->db->select_sum('actual');
                            $lib2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 6,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $mcc = $this->db->get_where('dailybymonths', array(
                                'street_id' => 17,
                                'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $this->db->select_sum('actual');
                            $mcc2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 17,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $obr = $this->db->get_where('dailybymonths', array(
                                'street_id' => 16,
                                'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $this->db->select_sum('actual');
                            $obr2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 16,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $nju = $this->db->get_where('dailybymonths', array(
                                'street_id' => 15,
                                'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $this->db->select_sum('cash');
                            $rel = $this->db->get_where('dailybymonths', array(
                                'street_id' => 22,
                                'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $this->db->select_sum('actual');
                            $rel2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 22,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
                            ...
                            $this->db->select_sum('cash');
                            $enf = $this->db->get_where('dailybymonths', array(
                                'street_id' => 23,
                                'month' => $month,
                                'year' => $year
                            ))->row()->cash;
                            ...
                            $this->db->select_sum('actual');
                            $enf2 = $this->db->get_where('dailybymonths', array(
                                'street_id' => 23,
                                'month' => $month,
                                'year' => $year
                            ))->row()->actual;
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
                                ...
                                var flotDashSales1Data = [{
                                    ...
                                    foreach ($streetlist as $str):
                                        if ($str['street_id'] == 1):
                                            $first = 'GWA';
                                            $this->db->select_sum('actual');
                                            $actualcash = $this->db->get_where('dailybymonth', array(
            ...
            <?php
                ...
                $this->db->select_sum('actual');
                $actualcash = $this->db->get_where('dailybymonth', array('street_id' => $str['street_id'],'month' => $month))->row()->actual;
                
				
				$this->db->select_sum('cash');
                $totalcash = $this->db->get_where('dailybymonth', array('street_id' => $str['street_id'],'month' => $month))->row()->cash;                 
				$this->db->select_sum('variance');
                $variancecash = $this->db->get_where('dailybymonth', array('street_id' => $str['street_id'],'month' => $month))->row()->variance;
